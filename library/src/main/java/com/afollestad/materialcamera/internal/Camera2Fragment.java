...
public class Camera2Fragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  private final CameraDevice.StateCallback mStateCallback =
    ...
    private static Size optimalPictureSize(BaseCaptureInterface ci, List<Size> choices) {
        int height;
        int width;
    ...
    public void openCamera() {
        ...
        try {
            ...
            int deviceNaturalOrientation = Degrees.getDeviceNaturalOrientation(getActivity());
            mDisplayOrientation =
